...
class Word2VecDBpedia():
    ...
    def loadFiles(self):
        f1 = open("../Data/Company_Headquarter/Company_headquarter_filtered.txt", 'w', encoding="utf-8")
        model = gensim.models.KeyedVectors.load_word2vec_format(
            'D:/dl4j-files/GoogleNews-vectors-negative300.bin/GoogleNews-vectors-negative300.bin', binary=True)

        f = open("../Data/Company_Headquarter/Company_headquarter_Clean.txt", 'r', encoding="utf-8")
        lines = f.readlines()
        linesNew = []
